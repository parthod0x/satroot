# SATROOT CLI reference

Complete command surface for the `satroot1` CLI and the smoke lanes.
See `README.md` for the overview, `INTEGRATION.md` for the Python API,
and `docs/TESTING.md` for running the suite.
