...
VARIANTS = [
    (
        ...
        "LICCAT01",
        "License Catalog Alpha",
        {
            "license_type": "software-license",
            "asset_id": "ops-catalog-alpha-suite",
            "licensor_entity": "satroot-labs-alpha",
            "licensee_entity": "customer-alpha",
            "usage_scope": "internal-alpha",
            "intended_use": "license-catalog-alpha",
        },
        {
            "holder_account": "license_catalog_holder_alpha",
            "archive_account": "license_catalog_archive_alpha",
            "retire": False,
        },
        {
            "channel": "alpha",
            "label": "License Catalog Alpha Release",
            "published_at": "2026-08-16T00:00:00Z",
        },
    ),
    (
        "license_catalog_beta.json",
        "LICCAT02",
        "License Catalog Beta",
        {
            "license_type": "software-license",
            "asset_id": "ops-catalog-beta-suite",
            "licensor_entity": "satroot-labs-beta",
            "licensee_entity": "customer-beta",
            "usage_scope": "internal-beta",
            "intended_use": "license-catalog-beta",
        },
        {
            "holder_account": "license_catalog_holder_beta",
            "archive_account": "license_catalog_archive_beta",
            "retire": False,
        },
        {
            "channel": "beta",
            "label": "License Catalog Beta Release",
...
def run_license_demo_release_catalog_smoke(
    output_dir: str | Path,
    *,
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the license singleton demo release-catalog publication convenience flow "
            "from staged presets and emit a compact verification report."
        )
    )
    parser.add_argument(
        "--output-dir",
        default=".tmp_license_demo_release_catalog_smoke_run",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = run_license_demo_release_catalog_smoke(
        args.output_dir,
